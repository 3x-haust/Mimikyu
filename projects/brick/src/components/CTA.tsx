export default function CTA() {
  return (
    <section className="relative w-[1259px] h-[597px]">
      ...
      {/* Title */}
      <h2 className="absolute left-[322px] top-[118px] w-[614px] h-[140px] font-[Pretendard] font-extrabold text-[64px] leading-[1.1em] tracking-[-0.005em] text-[#000000] text-center whitespace-pre-line">
        {"가장 견고한 프로젝트를\n시작할 준비가\u00A0되셨나요?"}
      </h2>

      {/* Subtitle */}
      <p className="absolute left-[304px] top-[305px] w-[650px] h-[64px] font-[Pretendard] font-medium text-[24px] leading-[1em] tracking-[-0.005em] text-[#666666] text-center whitespace-pre-line">
